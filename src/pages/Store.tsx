    ...
    details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">📊 Workflow Overview</h3>
    ...
    details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">🧠 Workflow Structure</h3>
    ...
    details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">🖼 Workflow Visual</h3>
     ...
     details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">🧭 Workflow Visuals</h3>
     ...
     details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">🖼 Visual Walkthrough</h3>
          <h3>1. Main Blog Generation Workflow</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>2. Google Docs + Image to WordPress Uploader</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
     ...
     details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3>Workflow 1 – Lead Import from LinkedIn</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>Workflow 2 – Email Follow-up Automation</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>Workflow 3 – LinkedIn Messaging System</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
     ...
     details: (
      <div className="space-y-8 text-gray-800">
        ...
        <div>
          ...
          <h3 className="text-xl font-bold mb-5">Workflow Visuals</h3>
          <p>Here’s a visual overview of the actual workflow setup built in n8n:</p>
          <h3>Workflow 1 – Lead Generation from Keywords</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>Workflow 2 - Lead Enrichment</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>Workflow 3 – Email Follow-up Automation</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
          ...
          <h3>Workflow 4 – LinkedIn Messaging System - Browserflow</h3>
          <div className="rounded-xl overflow-hidden border border-gray-300 shadow-sm">
            <img 
...
// --- UPDATED PRODUCT DETAIL COMPONENT ---
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            ...
            {/* CONDITIONAL RENDERING: Check if 'details' (rich content) exists */}
            {product.details ? (
              // If rich content exists, render it
              <div>{product.details}</div>
            ) : (
              // Fallback for other products without rich content
              <div>
            ...
            <div className="mb-6">
              ...
              <div className="flex rounded-md shadow-sm">
                ...
                <input 
                  ...
                  className="flex-1 min-w-0 block w-full px-4 py-3 rounded-none rounded-r-md border border-gray-300 focus:ring-black focus:border-black sm:text-lg" 
                />
              </div>
            </div>
            <button onClick={handleAddToCartClick} className="w-full bg-[#ff90e8] hover:bg-[#ff7ae2] text-black font-bold text-lg py-4 rounded-lg shadow-sm hover:shadow transition-all mb-4 border border-black/5">
              Add to cart
            </button>
...
const Checkout = ({ cart, onBack, onRemove, onPay }: { cart: Product[]; onBack: () => void; onRemove: (id: number) => void; onPay: (email: string) => void }) => {
  ...
  const handlePay = async () => {
    if(!formData.email || !formData.name || !formData.cardNumber || !formData.expiry || !formData.cvc) {
    ...
    try {
      ...
      if(response.ok) {
        ...
        // Fallback: Proceed to success even if webhook fails (optional)
    ...
    <div className="bg-[#111] min-h-screen text-gray-300 font-sans">
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        <div className="flex justify-between items-center mb-8 border-b border-gray-800 pb-4">
          ...
          <button onClick={onBack} className="text-gray-400 hover:text-white text-sm border border-gray-700 px-4 py-2 rounded transition-colors">
            Continue shopping
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="space-y-4 mb-6">
              {cart.map((item, idx) => (
                <div key={`${item.id}-${idx}`} className="bg-[#1a1a1a] rounded-lg border border-gray-800 p-4 flex gap-4 transition-all hover:border-gray-700">
                  <img src={item.image} alt={item.title} className="w-20 h-14 object-cover rounded bg-gray-800" />
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <h3 className="text-white font-medium text-sm">{item.title}</h3>
                      <span className="text-white font-bold">US${item.price.toFixed(2)}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-3 text-xs text-gray-400">
                      ...
                      <div className="flex gap-3">
                        ...
                        <button onClick={() => onRemove(item.id)} className="hover:text-red-400 underline">Remove</button>
                      </div>
                    </div>
                  </div>
                </div>
              ))}
              {cart.length === 0 && <div className="p-8 text-center text-gray-500 bg-[#1a1a1a] rounded border border-gray-800">Your cart is empty.</div>}
            </div>

            <div className="bg-[#1a1a1a] rounded-lg border border-gray-800 p-6 space-y-2 text-sm">
              ...
              <div className="flex justify-between text-white text-lg font-bold pt-4 border-t border-gray-700 mt-2">
                <span>Total</span>
          ...
          <div>
            <div className="bg-[#1a1a1a] p-6 rounded-lg border border-gray-800 space-y-6 sticky top-6">
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Email address <span className="text-red-500">*</span></label>
                <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="you@example.com" className="w-full bg-[#111] border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-blue-500" required />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Pay with</label>
                <div className="space-y-4">
                  <div>
                    <label className="text-xs text-gray-500 mb-1 block">Name on card <span className="text-red-500">*</span></label>
                    <input type="text" name="name" value={formData.name} onChange={handleInputChange} placeholder="John Doe" className="w-full bg-[#111] border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-blue-500" required />
                  </div>
                  <div>
                    <label className="text-xs text-gray-500 mb-1 block">Card information <span className="text-red-500">*</span></label>
                    <div className="relative">
                      <input type="text" name="cardNumber" value={formData.cardNumber} onChange={handleInputChange} placeholder="1234 5678 1234 5678" className="w-full bg-[#111] border border-gray-700 rounded p-3 text-white pl-10 focus:outline-none focus:border-blue-500" required />
                      <CreditCard className="absolute left-3 top-3.5 text-gray-500" size={18} />
                    </div>
                    <div className="flex gap-2 mt-2">
                      <input type="text" name="expiry" value={formData.expiry} onChange={handleInputChange} placeholder="MM / YY" className="w-1/2 bg-[#111] border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-blue-500" required />
                      <input type="text" name="cvc" value={formData.cvc} onChange={handleInputChange} placeholder="CVC" className="w-1/2 bg-[#111] border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-blue-500" required />
                    </div>
                  </div>
                </div>
              </div>
              <div>
                 ...
                 <select className="w-full bg-[#111] border border-gray-700 rounded p-3 text-white focus:outline-none focus:border-blue-500">
                   <option>India</option>
                   <option>United States</option>
                   <option>United Kingdom</option>
                 </select>
              </div>
              <button onClick={handlePay} disabled={loading} className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded transition-colors flex items-center justify-center gap-2 mt-4 disabled:opacity-50 disabled:cursor-not-allowed">
                 {loading ? (<> <Loader2 className="animate-spin" size={20} /> Processing... </>) : (<> <Lock size={16} /> Pay US${total.toFixed(2)} </>)}
              </button>
            </div>
            <p className="text-center text-xs text-gray-600 mt-4">Powered by Small Group Payments. Secure SSL Connection.</p>
          </div>
        </div>
      </div>
    </div>
...
const Store = () => {
  ...
  if (view === 'checkout') {
    return <Checkout cart={cart} onBack={() => setView('grid')} onRemove={handleRemoveFromCart} onPay={handlePaymentSuccess} />;
  }

  if (view === 'success') {
    return <SuccessPage email={customerEmail} onHome={() => setView('grid')} />;
  }
      ...
      <main className="flex-grow pt-24 pb-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          {view === 'detail' && selectedProduct ? (
            <ProductDetail product={selectedProduct} onBack={() => setView('grid')} onAddToCart={handleAddToCart} />
          ) : (
            <div className="animate-in fade-in duration-500">
              <div className="mb-10 flex justify-between items-end">
                ...
                {cart.length > 0 && (
                   <button onClick={() => setView('checkout')} className="text-blue-600 font-medium hover:underline">
